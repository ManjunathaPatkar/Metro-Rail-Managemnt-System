...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <a class="nav-item nav-link" style="font-size: 20px"href="smart_card_request_page.html">Smart card request</a>
      <a class="nav-item nav-link" style="font-size: 20px"href="user login.html">Smart card login</a>
      <a class="nav-item nav-link" style="font-size: 20px"href="#">Trains and Timings</a>
      <a class="nav-item nav-link" style="font-size: 20px"href="#">Routs and Stations</a>
      <a class="nav-item nav-link" style="font-size: 20px" href="#">Explore kudla</a>
