...
<div class = "container">
				...
				<div class="demo-content"><a href="admin_approve_cards.php"style="display:block;width: 400px;height:100px; background-color:rgba(0,255,0,0.45);text-align: center;padding: 20px;margin: 20px 20px; ">Smart Card details</a></div>
			</div>
		</div>
	
				<div class="demo-content"><a href="adminmanagetrains.php" style="display:block;width: 400px;height:100px; background-color:rgba(0,255,0,0.45);text-align: center;padding: 20px;margin: 30px 120px; ">Manage Trains</a></div>
			</div>
		
				<div class="demo-content"><a href="adminreplycomplaints.php" style="display:block;width: 400px;height:100px; background-color:rgba(0,255,0,0.45);text-align: center;padding: 20px;margin: 20px 120px; ">View Complaints</a></div>
			</div>
		</div>
